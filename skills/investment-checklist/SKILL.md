...
description: "本 skill 用于用户要求「买入前检查」「过 Checklist」「巴菲特清单」「这家公司能买吗」等买入前过关检查时。对一个或多个公司执行巴菲特价值投资买入前 Checklist。"
---


# 巴菲特价值投资买入前 Checklist

对 用户指定的输入 执行巴菲特价值投资买入前 Checklist 分析。
...
从 用户指定的输入 中解析出所有公司名称/代码。对每家公司确定：
- 公司全称、股票代码、上市交易所
