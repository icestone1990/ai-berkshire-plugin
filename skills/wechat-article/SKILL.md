---
name: wechat-article
description: "本 skill 用于用户要求「写公众号文章」「深度解读某主题」「可发布的长文」等需要产出可直接发布的微信公众号文章时。作者-编辑-读者三 Agent 协作。"
---


# 微信公众号文章：作者-编辑-读者三Agent协作

对 用户指定的输入 进行深度研究，产出一篇可直接发布的微信公众号文章。三个Agent各司其职：作者写深度初稿，编辑精修结构和表达，读者从目标受众视角审读。
