---
name: earnings-team
description: "本 skill 用于用户要求「团队解读财报」「四大师看财报」「财报写公众号」等需要四大师并行解读财报并产出可发布文章时。四大师并行精读 + 编辑润色 + 读者评审。"
---


# 财报精读团队：四大师并行解读 + 公众号发布

对 用户指定的输入 进行团队化财报精读分析。四位大师并行解读财报，编辑润色成文，读者评审把关质量，最终产出可直接发布的公众号文章。
