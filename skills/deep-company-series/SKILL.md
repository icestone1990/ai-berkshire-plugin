...
description: "本 skill 用于用户要求「写公司深度系列」「8 篇拆一家公司」「公众号长文系列」等需要教科书级深度并以系列长文公开发布时。8 篇约 12 万字，从认知重置到决策框架。"
---


# 深度公司系列：8 篇长文拆一家公司

为 用户指定的输入 撰写一个 8 篇深度长文系列，发布在公众号/视频号等公开渠道。**核心 IP 不是"会写"，而是"会改"——99% 的财经文章在违反本 skill 的事实核查标准**。
