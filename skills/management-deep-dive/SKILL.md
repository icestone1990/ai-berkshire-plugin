...
description: "本 skill 用于用户要求「研究管理层」「评估 CEO」「王兴/黄仁勋这个人怎样」「买股票就是买人」等管理层纵深研究时。深度评估管理层人品、能力与资本配置。"
---
...
使用 `${CLAUDE_PLUGIN_ROOT}/tools/financial_rigor.py verify-valuation` 校验回购时和当前的PE等估值指标。
